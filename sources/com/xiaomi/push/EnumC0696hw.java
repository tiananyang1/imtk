...
/* loaded from: classes08-dex2jar.jar:com/xiaomi/push/hw.class */
public enum EnumC0696hw {
    Registration(1),
    UnRegistration(2),
    Subscription(3),
    UnSubscription(4),
    ...
    RevokeMessage(114),
    SimulatorJob(DebugViews.LOG_MSG_LIMIT);
    ...
    /* renamed from: a */
    public static EnumC0696hw m1613a(int i) {
        if (i == 200) {
            return SimulatorJob;
        }
        switch (i) {
