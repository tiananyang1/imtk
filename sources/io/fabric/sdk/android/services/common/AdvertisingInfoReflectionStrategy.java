...
/* loaded from: classes08-dex2jar.jar:io/fabric/sdk/android/services/common/AdvertisingInfoReflectionStrategy.class */
class AdvertisingInfoReflectionStrategy implements AdvertisingInfoStrategy {
    ...
    private String getAdvertisingId() {
        try {
            ...
            Fabric.getLogger().mo2878w(Fabric.TAG, "Could not call getId on com.google.android.gms.ads.identifier.AdvertisingIdClient$Info");
            return null;
        }
    }
    ...
    private Object getInfo() {
        try {
            ...
            Fabric.getLogger().mo2878w(Fabric.TAG, "Could not call getAdvertisingIdInfo on com.google.android.gms.ads.identifier.AdvertisingIdClient");
            return null;
        }
    }
    ...
    private boolean isLimitAdTrackingEnabled() {
        try {
            ...
            Fabric.getLogger().mo2878w(Fabric.TAG, "Could not call isLimitAdTrackingEnabled on com.google.android.gms.ads.identifier.AdvertisingIdClient$Info");
            return false;
        }
    }
