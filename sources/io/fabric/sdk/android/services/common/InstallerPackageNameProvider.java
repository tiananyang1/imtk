...
/* loaded from: classes08-dex2jar.jar:io/fabric/sdk/android/services/common/InstallerPackageNameProvider.class */
public class InstallerPackageNameProvider {
    ...
    public String getInstallerPackageName(Context context) {
        try {
            ...
            Fabric.getLogger().mo2873e(Fabric.TAG, "Failed to determine installer package name", e);
            return null;
        }
    }
}
