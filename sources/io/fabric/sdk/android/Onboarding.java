...
/* loaded from: classes08-dex2jar.jar:io/fabric/sdk/android/Onboarding.class */
public class Onboarding extends Kit<Boolean> {
    ...
    private boolean performAutoConfigure(String str, AppSettingsData appSettingsData, Collection<KitInfo> collection) {
        if (AppSettingsData.STATUS_NEW.equals(appSettingsData.status)) {
            ...
            Fabric.getLogger().mo2873e(Fabric.TAG, "Failed to create app with Crashlytics service.", null);
            return false;
        }
        ...
        Fabric.getLogger().mo2870d(Fabric.TAG, "Server says an update is required - forcing a full App update.");
    ...
    private SettingsData retrieveSettingsData() {
        try {
            ...
            Fabric.getLogger().mo2873e(Fabric.TAG, "Error dealing with settings", e);
            return null;
        }
    }
    ...
    public Boolean doInBackground() {
        ...
        if (retrieveSettingsData != null) {
            try {
                ...
                Fabric.getLogger().mo2873e(Fabric.TAG, "Error performing auto configuration.", e);
            }
    ...
    public boolean onPreExecute() {
        try {
            ...
            Fabric.getLogger().mo2873e(Fabric.TAG, "Failed init", e);
            return false;
        }
    }
}
