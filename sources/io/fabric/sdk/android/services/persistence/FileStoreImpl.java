...
/* loaded from: classes08-dex2jar.jar:io/fabric/sdk/android/services/persistence/FileStoreImpl.class */
public class FileStoreImpl implements FileStore {
    ...
    boolean isExternalStorageAvailable() {
        ...
        Fabric.getLogger().mo2878w(Fabric.TAG, "External Storage is not mounted and/or writable\nHave you declared android.permission.WRITE_EXTERNAL_STORAGE in the manifest?");
        return false;
    }

    File prepare(File file) {
        if (file == null) {
            Fabric.getLogger().mo2870d(Fabric.TAG, "Null File");
            return null;
        }
        if (!file.exists() && !file.mkdirs()) {
            Fabric.getLogger().mo2878w(Fabric.TAG, "Couldn't create file");
            return null;
        }
        return file;
    }
