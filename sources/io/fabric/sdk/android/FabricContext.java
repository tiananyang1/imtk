...
/* loaded from: classes08-dex2jar.jar:io/fabric/sdk/android/FabricContext.class */
class FabricContext extends ContextWrapper {
    ...
    public SharedPreferences getSharedPreferences(String str, int i) {
        return super.getSharedPreferences(this.componentName + Constants.COLON_SEPARATOR + str, i);
    }
