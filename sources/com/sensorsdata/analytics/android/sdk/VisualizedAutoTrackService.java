...
/* loaded from: classes08-dex2jar.jar:com/sensorsdata/analytics/android/sdk/VisualizedAutoTrackService.class */
    ...
    public void start(Activity activity, String str, String str2) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= 16) {
                ...
                mVTrack = new VisualizedAutoTrackViewCrawler(activity, str3, str, str2);
                mVTrack.startUpdates();
            }
        } catch (Exception e) {
            SALog.printStackTrace(e);
