...
/* loaded from: classes08-dex2jar.jar:com/xiaomi/push/h.class */
public enum EnumC0673h {
    ...
    STATUS_BAR(Cell.CERTS),
    SYSTEM_ALERT_WINDOW(Cell.AUTH_CHALLENGE),
    TRANSMIT_IR(Cell.AUTHENTICATE),
    UNINSTALL_SHORTCUT(Cell.AUTHORIZE),
