...
/* loaded from: classes08-dex2jar.jar:io/fabric/sdk/android/services/settings/Settings.class */
public class Settings {
    ...
    /* loaded from: classes08-dex2jar.jar:io/fabric/sdk/android/services/settings/Settings$LazyHolder.class */
    ...
    /* loaded from: classes08-dex2jar.jar:io/fabric/sdk/android/services/settings/Settings$SettingsAccess.class */
    ...
    public SettingsData awaitSettingsData() {
        try {
            ...
            Fabric.getLogger().mo2872e(Fabric.TAG, "Interrupted while waiting for settings data.");
            return null;
        }
    }
    ...
    public boolean loadSettingsSkippingCache() {
        ...
        synchronized (this) {
            ...
            if (loadSettingsData == null) {
                Fabric.getLogger().mo2873e(Fabric.TAG, "Failed to force reload of settings from Crashlytics.", null);
            }
            z = loadSettingsData != null;
        }
        return z;
